...
RESOURCES += src/qt/hitex.qrc src/qt/hitex_locale.qrc

TRANSLATIONS += src/qt/locale/hitex_bg.ts \
                src/qt/locale/hitex_de.ts \
                src/qt/locale/hitex_en.ts \
                src/qt/locale/hitex_es.ts \
                src/qt/locale/hitex_fi.ts \
                src/qt/locale/hitex_fr.ts \
                src/qt/locale/hitex_it.ts \
                src/qt/locale/hitex_ja.ts \
                src/qt/locale/hitex_pl.ts \
                src/qt/locale/hitex_pt.ts \
                src/qt/locale/hitex_ru.ts \
                src/qt/locale/hitex_sk.ts \
                src/qt/locale/hitex_sv.ts \
                src/qt/locale/hitex_vi.ts \
                src/qt/locale/hitex_zh_CN.ts \
                src/qt/locale/hitex_zh_TW.ts
