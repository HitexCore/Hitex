...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HITEX features */
        {"hitex", "masternode", &masternode, true, true, false},
        {"hitex", "masternodelist", &masternodelist, true, true, false},
        {"hitex", "mnbudget", &mnbudget, true, true, false},
        {"hitex", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"hitex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hitex", "mnsync", &mnsync, true, true, false},
        {"hitex", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"hitex", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hitexd, or the -server option to hitex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hitex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7891/\n";
}
