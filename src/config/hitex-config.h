/* src/config/hitex-config.h.  Generated from hitex-config.h.in by configure.  */
/* src/config/hitex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HITEX_CONFIG_H

#define HITEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.hitexs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hitex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hitex Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hitex"
