...
/** Utility functions used by the HITEX Qt UI.
 */
namespace GUIUtil
{
...
// Render HITEX addresses in monospace font
...
// Parse "hitex:" URI into recipient object, return true on successful parsing
