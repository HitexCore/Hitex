...
#if defined(NDEBUG)
#error "Hitex cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Hitex Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 720 ) {
	        nSubsidy = 2 * COIN;
	} else if( nHeight > 720 && nHeight <= 40320 ) {
	        nSubsidy = 10 * COIN;
	} else if( nHeight > 40320 && nHeight <= 121000 ) {
	        nSubsidy = 8 * COIN;
	} else if( nHeight > 121000 && nHeight <= 484000 ) {
	        nSubsidy = 6 * COIN;
	} else if( nHeight > 484000 && nHeight <= 968000 ) {
	        nSubsidy = 4 * COIN;
	} else {
		nSubsidy = 2 * COIN;
	}
